...
| **Rundenbilanz** | Bevor gewählt wird, kommt **alles Falsche der Runde** auf die Leinwand — **ohne Namen**. Man wählt die Antwort, nicht die Person; wer sie geschrieben hat, fällt erst bei der Auszählung. |
| **Voting** | Auf dem Stimmzettel stehen **bis zu zwölf Fehlgriffe** der Runde — jeder Spieler mindestens einmal, aufgefüllt mit dem restlichen Unsinn. Man wählt die dümmste; die eigene ist gesperrt. Keine Namen, nirgends. |
...
| **Geisterzone** | Rausgeflogene bleiben im Spiel: Sie **sehen jede Frage weiter mit**, chatten, lassen Emojis auf die Bühne regnen, sagen den nächsten Rauswurf voraus — und haben im Finale bei Gleichstand die entscheidende Stimme. |
| **Finale** | Die letzten zwei spielen **eine letzte Runde** — gleiche Länge wie jede andere. Es gewinnt, **wer mehr Fragen richtig hat**. Auch hier wird die Kategorie gezogen, nicht gewählt. **Zu zweit** geht es sofort hierhin — ohne Rausschmiss, direkt ins Duell. |
| **Duell-Nachlese** | Egal wie es ausgeht: Zum Schluss kommt **alles auf die Leinwand, was die zwei getippt haben** — mit Namen. |
| **Zuschauer-Voting** | Gleich viele richtig? Dann entscheiden die **Rausgeflogenen**: Welche der beiden Antworten war die dümmste? Wer sie geschrieben hat, verliert. Die zwei auf der Bühne stimmen nicht mit — der Server weist ihre Stimme ab. Gibt es keine Zuschauer oder sind auch die sich uneinig, zählt die **gesamte Antwortzeit**: Wer schneller getippt hat, gewinnt. |
| **Ergebnis** | Krönung mit Konfetti, Awards, Highlight-Recap, Revanche-Knopf. |

Bei 8–9 Spielern fliegen in den ersten Runden zwei auf einmal — so bleibt der Abend bei 25–40 Minuten.

**Einstellungen** öffnet das Zahnrad oder **Escape**: Musik und Effekte getrennt regelbar, alles stummschaltbar, Vollbild, Raum-Code und Einladungslink mittig — der Ausstieg steht abgesetzt ganz unten. Die Spielregeln stehen währenddessen ohnehin offen in der Lobby.

**Dein Profil** öffnet ein Klick auf das eigene Bild oben links: Figur, Name, die eigenen Zahlen — und ein Schalter, der Name und Figur in diesem Browser merkt. Beim nächsten Abend steht beides schon im Formular. Kein Konto, kein Passwort, nichts verlässt das Gerät.
...
Wer die **Lobby erstellt, ist der Gastgeber**: Er stellt Antwortzeit, Fragen pro Runde, Kategorien und Moderator-Härtegrad direkt in der Lobby ein, startet das Spiel und hat während einer Frage einen Notfallknopf („Frage ist kaputt"), der sie sofort austauscht und meldet.
